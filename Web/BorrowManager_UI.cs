...
namespace Web
{
    public partial class BorrowManager_UI : Form
    {
        ...
        private void BorrowManager_UI_Load(object sender, EventArgs e)
        {
            ...
            //需要添加列的列标题字符串
            string arraysHeaderText = @"读者编号,读者名称,登记时间,有效时间,图书类型,所在院系,所在班级,身份证号,性别,电话,手机,Email,联系地址,描述信息";
            //需要绑定数据库列名称的字符串
            ...
            //需要添加列的列标题字符串
            string arraysHeaderText2 = @"图书编号,图书名称,登记时间,图书类型,作者,拼音码,翻译,语言,页数,价格,印刷版面,存放位置,ISBN码,版本,描述";
            //需要绑定数据库列名称的字符串
        ...
        private void labBorrowBook_Click(object sender, EventArgs e)
        {
        ...
        private void dgvReaderInfo_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
